...
export const BookingformTicketer = () => {
    ...
    const getData = (e) => {// this is for retrieving booking info
        e.preventDefault();
    ...
    return (
        <div className="wrapper ">
            ...
            <div className="sidebar" data-color="white" background-image="../assets/img/sidebar-1.jpg">
                        ...
                        <div >
                            {
                                userbooking.map((bookingdata, index) => {
                                    return <div key={index} className="card" id="retrieve-card">
                                        ...
                                        <p>Total Seats : {bookingdata.data.totalceats}</p>
                                        <p>Seat Names : {bookingdata.data.ceatnames}</p>
