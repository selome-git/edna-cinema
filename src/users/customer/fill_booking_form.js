...
export const Bookingform = () => {
    ...
    const selectCeats = (e) => {
        ...
        if (username === "" || moviename === "" || ticketcost === "" || bookingdate === "") {
            ...
            history.push({ pathname: '/pickseat', state: { profile: profile, email: email, movieimage: movieimage, username: username, mobile: mobile, moviename: moviename, ticketcost: ticketcost, bookingdate: bookingdate, password: password } })
        }
    ...
    return (
        <div class="form-container sign-in-container" className="movie-container" >
            <form style={{ background: '#f6f5f7' }}>
                ...
                <br />
                <button onClick={selectCeats}>Select Seats</button>
            </form>
        </div>
    )
}
