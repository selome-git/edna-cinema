...
export const Ticketbookingform = () => {
    ...
    const paymentFunction = (e) => {
        ...
        e.preventDefault();
        var options = {
            key: "rzp_test_2NUSRXWFy5KX0Q", // Enter the Key ID generated from the Dashboard
            key_secret: "fRhF7ZMhY3tnkwrt34FRiflw",
            ...
            handler: function (response) {
                ...
                fire.firestore().collection("Bookings").add({
                    ...
                    history.push({ pathname: "/success", state: { profile: profile, email: email, password: password, mobile: mobile, bookingdate: bookingdate, username: username, totalseats: seats, seatnames: allSeatarray, name: name, moviename: moviename, ticketcost: ticketcost } })
    ...
    return (
        <div class="form-container sign-in-container" className="ticket-booking" >
            <form className="seat-pick" style={{ background: '#f6f5f7', marginTop: "32%" }}>
                ...
                <div className="inputForm">
                    ...
                    <input type="button" value="Pick Cetas" className="pick-seats" onClick={startSelect} />
                </div>
